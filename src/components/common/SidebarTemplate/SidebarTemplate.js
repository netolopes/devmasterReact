            ...
            <div className={classnames('d-flex', {'toggled': this.state.toggled})} id="wrapper">
                ...
                <div id="page-content-wrapper">
                    <nav className="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                        <button className="btn btn-light" onClick={this.minimizeSidebar}> {this.state.toggled ? <i className='fas fa-eye fa-lg'></i> : <i className='fas fa-eye-slash fa-lg'></i>} </button>
