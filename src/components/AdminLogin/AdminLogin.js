                                ...
                                <form onSubmit={this.onSubmitHandler}>
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            ...
                                            <input type="text" name='email' className={classnames('form-control form-control-lg', {'is-invalid': errors.notFound})} placeholder="Username: admin" onChange={this.onChangeHandler} />
